export default {
	"en-US": {
		Header: {
			subTitle: "Data Technician student specialising in programming",
			link1: "Portfolio",
			link2: "About me",
		},
		HomePage: {
			header: "My Skills",
			txt1: "* Use your mouse to click on chest and play around",
		},
		AboutPage: {
			...
			section1: {
				...
				txt2: "I am 23 years old guy from Latvia who loves to learn and write code and experiment with a lot of new exciting things.",
			...
			section2: {
				...
				txt2: "ReactJs and ReactNative",
				txt3: "C# and .Net with Entity Framework",
				txt4: "SQL, MongoDb",
				txt5: "Tried a bit of Python and Java",
				txt6: "Basics of ITIL Business cases and ITIL principles in documentation",
				txt7: "Basics of DevOps, SCRUM and Agile principles",
				txt8: "Currently I am learning some Kotlin",
			},
			section3: {
			...
			section5: {
				header: "Contact me",
				txt1: "You can reach me by email: <b>moisejenko11@gmail.com</b>",
				txt2: "Or you can check out my github: ",
			},
		},
	},
	"da-DK": {
		Header: {
			subTitle: "Datatekniker student med speciale i programmering ",
			link1: "Portefølje",
			link2: "Om mig",
		},
		HomePage: {
			header: "Mine færdigheder",
			txt1: "* Brug musen til at klikke på kisten og lege rundt ",
		},
		AboutPage: {
			welcome: " mit navn er Dainis",
			section1: {
				txt1: "Jeg er Datatekniker med speciale i programmering student fra København som studerer i øjeblikket på TEC Ballerup.",
				txt2: "Jeg er 23 år gammel fyr fra Letland, der elsker at lære og skrive kode samt eksperimentere med en masse nye spændende ting.",
			...
			section2: {
				...
				txt1: "HTML, CSS, JavaScript",
				txt2: "ReactJs og ReactNative",
				txt3: "C# og .Net med Entity Framework",
				txt4: "SQL, MongoDb",
				txt5: "Har prøvet lidt af Python og Java",
				txt6: "Grundlæggende om ITIL Business cases og ITIL – principper i dokumentation",
				txt7: "Havde grundlæggende om DevOps, SCRUM og Agile principper",
				txt8: "I øjeblikket er jeg ved at lære noget Kotlin ",
			},
			section3: {
			...
			section4: {
				...
				txt3: "Jeg elsker at rejse (bil road trip inkluderet) ",
